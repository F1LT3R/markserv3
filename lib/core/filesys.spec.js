...
describe(specPath, () => {
	...
	describe('.findFileUp()', () => {
		...
		it(`Markconf.js should exist 1 level up`, () => {
			const markconfUri = filesys.findFileUp(__dirname, 'Markconf.js')
			const actual = path.relative(__dirname, markconfUri)
			expect(actual).to.equal('../../Markconf.js')
		})
